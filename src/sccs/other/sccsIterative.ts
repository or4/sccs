...
//     if (R.isNil(graphItem) || !(stackItemVertice && graphItem.vertex === stackItemVertice) && graphItem.visited) {
//       while (true) {
...
//     if (R.isNil(graphItem) || !(stackItem && graphItem.vertex === stackItem.vertice) && graphItem.visited) {
//       while (true) {
//         stackItem = stack.pop();
